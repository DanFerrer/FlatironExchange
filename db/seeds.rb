...
steph = User.create(
  ...
  email: "testflexchange@gmail.com",
  image_url: "https://avatars.githubusercontent.com/u/7061844?v=3",
  provider: "github",
  uid: "7061844"
)
...
Answer.create(
  content: "@KatieHoffman Stop telling people to bar instead of foo",
  question_id: 6,
  responder_id: steph.id
)
